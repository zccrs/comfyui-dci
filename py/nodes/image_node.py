...
class DCIImage(BaseNode):
    ...
    def _execute(self, **kwargs):
        ...
        background_color = kwargs.get(t("background_color")) or kwargs.get("background_color", "transparent")
        custom_bg_r = kwargs.get(t("custom_bg_r")) or kwargs.get("custom_bg_r", 255)
        custom_bg_g = kwargs.get(t("custom_bg_g")) or kwargs.get("custom_bg_g", 255)
        custom_bg_b = kwargs.get(t("custom_bg_b")) or kwargs.get("custom_bg_b", 255)
        layer_priority = kwargs.get(t("layer_priority")) or kwargs.get("layer_priority", 1)
        layer_padding = kwargs.get(t("layer_padding")) or kwargs.get("layer_padding", 0)
        palette_type = kwargs.get(t("palette_type")) or kwargs.get("palette_type", "none")
        hue_adjustment = kwargs.get(t("hue_adjustment")) or kwargs.get("hue_adjustment", 0)
        saturation_adjustment = kwargs.get(t("saturation_adjustment")) or kwargs.get("saturation_adjustment", 0)
        brightness_adjustment = kwargs.get(t("brightness_adjustment")) or kwargs.get("brightness_adjustment", 0)
        red_adjustment = kwargs.get(t("red_adjustment")) or kwargs.get("red_adjustment", 0)
        green_adjustment = kwargs.get(t("green_adjustment")) or kwargs.get("green_adjustment", 0)
        blue_adjustment = kwargs.get(t("blue_adjustment")) or kwargs.get("blue_adjustment", 0)
        alpha_adjustment = kwargs.get(t("alpha_adjustment")) or kwargs.get("alpha_adjustment", 0)
